...
for e=1:numElem
    ...
    Area = 0.5*det([ones(3,1),nodes(elem(e,:),:)]);
    Fe = th*Area*gTimesRho*[0; -1; 0; -1; 0; -1]/3.0;
...
%fprintf('(c) Maximum of the horizontal displacements of the bottom boundary nodes: %.4e\n',...
...
% displacementet"
%
fprintf('Problem 5(c) Maximum of the vertical displacements of the bottom boundary nodes: %.4e\n',...
